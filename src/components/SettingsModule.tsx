              ...
              <div className="space-y-6 animate-fadeIn" id="content-changelog">
                ...
                <div className="relative border-l-2 border-slate-100 pl-4 ml-2 space-y-6">
                  ...
                  <div className="relative group">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="text-xs font-black text-slate-800">Versi v1.11.0 (Auto-suggest Pencarian & Urutan Kronologis)</span>
                      ...
                      <ul className="list-disc pl-4 text-xs text-slate-600 mt-2 space-y-1">
                        <li><strong>Penyortiran Kronologis (Oldest First):</strong> Menyusun daftar rencana pembayaran dalam pembuatan invoice baru berdasarkan tanggal bayar terlama berada di paling atas guna prioritas jatuh tempo.</li>
                        <li><strong>Mekanisme Pencarian Auto-suggest (AutoComplete):</strong> Menambahkan kotak pencarian pintar di atas daftar pilihan di mana mengetik nama rekanan, kategori, tanggal, atau catatan akan menyarankan pilihan pencocokan yang siap dicentang dengan sekali klik.</li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="relative group">
                    ...
                    <div>
                      ...
                      <span className="text-[10px] text-slate-400 block mt-0.5">9 Juni 2026</span>
                      <ul className="list-disc pl-4 text-xs text-slate-600 mt-2 space-y-1">
                        <li><strong>Fitur Setujui Sekaligus (Bulk Approval):</strong> Menambahkan fitur pemilihan rencana pembayaran berstatus 'Draft' dengan kotak centang (checkbox) untuk disetujui secara massal sekaligus oleh Direktur Utama atau Administrator, mereduksi waktu manajemen persetujuan.</li>
                        <li><strong>Optimalisasi Notifikasi & Penghilangan Popup Menengah:</strong> Menghilangkan dialog popup alert yang mengganggu ("Sukses menyimpan draf pembayaran...") setelah berhasil menyimpan pembayaran baru agar proses pendaftaran draf menjadi lebih mulus dan efektif tanpa interupsi.</li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="relative group">
                    ...
                    <div>
                      ...
                      <span className="text-[10px] text-slate-400 block mt-0.5">9 Juni 2026</span>
                      <ul className="list-disc pl-4 text-xs text-slate-600 mt-2 space-y-1">
                        <li><strong>Opsi Sunting/Edit Draf Pembayaran:</strong> Pengguna dengan peran berwenang (Supervisor Keuangan atau Administrator) dapat menyunting data Rencana Pembayaran berstatus "Draft" sebelum disetujui Direktur. Sifatnya dinamis dan secara otomatis memuat seluruh draf data ke formulir input utama pelaku kustomisasi.</li>
                  ...
                  <div className="relative group">
                    ...
                    <div>
                      ...
                      <span className="text-[10px] text-slate-400 block mt-0.5">8 Juni 2026</span>
                      <ul className="list-disc pl-4 text-xs text-slate-600 mt-2 space-y-1">
                        <li><strong>Akurasi Deteksi Koneksi Firebase:</strong> Memperbaiki deteksi konektivitas Firebase melalui pembacaan langsung global `import.meta.env` secara andal tanpa kendala typecasting di sisi runtime browser.</li>
                        <li><strong>Restorasi & Logika Self-Healing Akun:</strong> Optimalisasi pemulihan mandiri akun default agar aktif memverifikasi dan menyisipkan data pengguna default jika terhapus dari basis data Firestore, menjaga keamanan operasional tanpa bergantung pada database kosong sepenuhnya.</li>
                      </ul>
                    </div>
                  </div>
